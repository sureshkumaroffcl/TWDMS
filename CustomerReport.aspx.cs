...
namespace TwoWheelerDealership.TWD.TWD_Admin
{
    public partial class CustomerReport1 : System.Web.UI.Page
    {
     ...
     .ToArray());
            ...
            gvCustomer.DataSource = filteredDT;
            gvCustomer.DataBind();
       ...
       .ToArray());
            ...
            rpt.Load(Server.MapPath("CustomerReport.rpt"));
            ...
            rptvewCustomer.ReportSource = rpt;
            rptvewCustomer.RefreshReport();

            rptvewCustomer.DataBind();

            Response.ClearContent();
            Response.ClearHeaders();
            Response.Buffer = false;

            rpt.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, false, "Customer Details");
